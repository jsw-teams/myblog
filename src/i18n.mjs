...
const dictionaries = {
  "zh-CN": {
    ...
    articleEnd: "读到这里",
    commentsTitle: "评论",
    commentsLoading: "正在读取 GitHub Issue 评论...",
    commentsEmpty: "还没有公开评论。",
    commentsError: "评论读取失败，可以稍后刷新页面。",
    commentsReadOnlyMainland: "中国大陆访问当前仅开放阅读评论，暂不开放提交评论功能。",
    commentsOpenIssue: "到 GitHub 登录并评论",
    commentsCreateIssue: "创建评论 Issue",
    commentsRules: "评论通过 GitHub Issue 承载，需要 GitHub 账号。请保持相关、友善，明显广告、重复内容或恶意链接会被移除。",
  ...
  "zh-TW": {
    ...
    articleEnd: "讀到這裡",
    commentsTitle: "評論",
    commentsLoading: "正在讀取 GitHub Issue 評論...",
    commentsEmpty: "還沒有公開評論。",
    commentsError: "評論讀取失敗，可以稍後重新整理頁面。",
    commentsReadOnlyMainland: "中國大陸訪問目前僅開放閱讀評論，暫不開放提交評論功能。",
    commentsOpenIssue: "到 GitHub 登入並評論",
    commentsCreateIssue: "建立評論 Issue",
    commentsRules: "評論透過 GitHub Issue 承載，需要 GitHub 帳號。請保持相關、友善，明顯廣告、重複內容或惡意連結會被移除。",
  ...
  en: {
    ...
    commentsLoading: "Loading GitHub Issue comments...",
    commentsEmpty: "No public comments yet.",
    commentsError: "Comments could not be loaded. Please refresh later.",
    commentsReadOnlyMainland: "Mainland China access is read-only for comments. New comments are not available from this region.",
    commentsOpenIssue: "Sign in on GitHub to comment",
    commentsCreateIssue: "Create comment issue",
    commentsRules: "Comments are hosted through GitHub Issues and require a GitHub account. Please stay relevant and kind; obvious ads, repeated posts, or malicious links may be removed.",
