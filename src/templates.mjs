...
<body${renderAttributes(bodyAttrs)}>
  ...
  <script src="/assets/privacy-plugin-loader.js?v=20260520v4v4" data-config="/assets/privacy-plugins.json" data-stylesheet="/assets/privacy-plugin-banner.css" defer></script>
</body>
</html>`;
}
